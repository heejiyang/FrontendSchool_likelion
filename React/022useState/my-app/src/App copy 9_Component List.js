...
function Hello(props) {
  ...
  // const numComponentsArray = num.map(v => <p>{name}안녕, {v}호</p>)
  ...
  return(
    <div>
      {/* "리스트 각 요소가 고유한 key 값을 가지지 않았다."-> 콤마를 없애고 요소를 밖으로 꺼내줍니다. 이것을 리스트로 렌터링 한다고 얘기합니다. */}
      {/* ['hello', 'world' 3, 4, 5] */}
      {numComponentsArray}
      {/* 드물지만 이런 경우가 생길 수 있으므로 권장하지 않는다는 얘기입니다.*/}
